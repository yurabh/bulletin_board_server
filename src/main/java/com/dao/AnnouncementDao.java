...
/**
 * {@link AnnouncementDao} interface serves for the data access process for
 * {@link Announcement} in database has extend {@link CRUDDao} methods and other
...
public interface AnnouncementDao extends CRUDDao<Announcement> {
    ...
    /**
     * This interface method removes the {@link Announcement}
     * from the database and accepts the ID for deleting.
     *
     * @param id int.
     */
    ...
    /**
     * This interface method removes all announcements
     * from the database for a specific {@link com.domain.Heading#id}.
     *
     * @param id int.
     */
