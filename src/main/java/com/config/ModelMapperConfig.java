...
/**
 * This is {@link ModelMapperConfig} class which sets all
...
public class ModelMapperConfig {
     ...
     * Sets matching fields to be enabled.
     * Skips when the property value is {@code null}.
     * Sets {@code AccessLevel} to private.
     *
     * @param converters Converters, that are used by {@link ModelMapper}
     *                   and are discovered by Spring.
